...
open class DefaultFakeOverrideBuilder : FakeOverrideBuilderStrategy {
    ...
    override val propertyOverriddenSymbols: MutableMap<IrOverridableMember, List<IrSymbol>> = mutableMapOf()
